      ...
      <nav className="sidebar-nav">
        ...
        {role === 'Architect' && (
          <>
            ...
            <div
              style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '1.5rem', marginBottom: '0.5rem', paddingLeft: '1.5rem', paddingRight: '1rem', fontSize: '0.9rem', fontWeight: 'bold', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.05em', cursor: 'pointer' }}
              onClick={() => setIsConsultantsOpen(!isConsultantsOpen)}
            >
              <span>Partners & Consultants</span>
              {isConsultantsOpen ? <ChevronDown size={18} /> : <ChevronRight size={18} />}
            </div>
